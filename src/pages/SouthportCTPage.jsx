...
const SouthportCTPage = () => {
  return (
    <div className="bg-black min-h-screen text-white">
      <Helmet>
        <title>
          Mobile Auto Detailing in Southport, CT 
        </title>
        <meta
          name="description"
          content="Premium mobile detailing in Southport, CT. We bring our own water and power for interior & exterior details, paint correction, and ceramic coating at your home or driveway."
        />
      ...
      <section className="relative pt-32 pb-16 bg-gradient-to-b from-black via-zinc-950 to-black overflow-hidden">
        ...
        <div className="relative z-10 max-w-5xl mx-auto px-6 space-y-6">
          <p className="text-[11px] uppercase tracking-[0.35em] text-zinc-500">
            NAS AUTO SPA • SOUTHPORT, CT
          </p>

          <h1 className="text-3xl md:text-4xl lg:text-5xl font-semibold tracking-tight">
            <span className="bg-gradient-to-r from-[#e1b11b] via-amber-300 to-yellow-500 bg-clip-text text-transparent">
              Mobile detailing in Southport
            </span>{" "}
            for a clean, coastal daily driver.
          </h1>

          <p className="text-sm md:text-base text-zinc-300 max-w-2xl">
            Southport roads, salt air, and everyday use can quickly dull your car&apos;s
            finish and interior. We bring professional, on-site detailing that keeps your
            vehicles clean, glossy, and protected — without you leaving home.
          </p>
          ...
          <div className="flex flex-wrap items-center gap-3 pt-2">
            ...
            <span className="text-xs text-zinc-500">
              High-touch, detail-oriented service for Southport drivers.
            </span>
          </div>
        ...
        <div className="max-w-5xl mx-auto px-6 space-y-10">
          <section className="border border-zinc-800 rounded-3xl bg-zinc-950/70 p-6 md:p-8 space-y-4">
            <p className="text-[11px] uppercase tracking-[0.3em] text-zinc-500">
              Southport Mobile Detailing
            </p>
            <h2 className="text-xl md:text-2xl font-semibold tracking-tight">
              Keep your Southport vehicle looking as clean as the coastline
            </h2>
            <p className="text-sm md:text-base text-zinc-300">
              We&apos;re here for the people who care about how their car looks and feels every
              time they drive it. Our mobile setup turns your driveway into a private detail
              bay — with safe wash techniques, interior deep cleaning, and optional long-term
              protection like ceramic coating.
            </p>
          </section>
          ...
          <div className="grid gap-8 md:grid-cols-2">
            ...
            <section className="border border-zinc-800 rounded-3xl bg-zinc-950/60 p-6 md:p-7 space-y-4">
              <h3 className="text-lg md:text-xl font-semibold">
                Great fit for Southport lifestyles
              </h3>
              <p className="text-sm md:text-base text-zinc-300">
                Ideal if you:
              </p>
              <ul className="text-sm text-zinc-200 space-y-1">
                <li>• Want your daily driver to look garage-kept</li>
                <li>• Own a weekend or coastal vehicle</li>
                <li>• Care about keeping your paint and interior protected</li>
                <li>• Prefer a private, on-site detailing experience</li>
              </ul>
            </section>
          </div>
          ...
          <section className="mt-4 border border-zinc-800 rounded-3xl bg-zinc-950/70 p-6 md:p-8 flex flex-col md:flex-row md:items-center justify-between gap-4">
            <div>
              <h3 className="text-lg md:text-xl font-semibold">
                Book mobile detailing in Southport, CT
              </h3>
              <p className="text-sm md:text-base text-zinc-300 mt-1">
                Tell us about your vehicle and where you&apos;re located in Southport —
                we&apos;ll follow up with availability and details.
              </p>
            </div>
...
export default SouthportCTPage;
