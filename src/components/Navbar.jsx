      ...
      <div className="container mx-auto">
        <div className="flex items-center justify-between">
          ...
          <div className="hidden md:flex items-center space-x-12">
            ...
            <a href="#contact" className="text-[#e1b11b] text-lg font-bold hover:text-[#e1b11b]/80 transition-colors duration-300 bg-black/50 backdrop-blur-sm px-4 py-2 rounded-md">Contact</a>
          </div>
