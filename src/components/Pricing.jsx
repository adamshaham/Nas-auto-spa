...
const Pricing = () => {
  ...
  return (
    <section id="pricing" className="py-24 bg-gradient-to-b from-slate-100 to-white">
      <div className="container-wrapper">
        <div className="text-center max-w-3xl mx-auto mb-16">
          <span className="text-gold-400 font-semibold text-lg tracking-wider">OUR PACKAGES</span>
