      ...
      <div className="container-wrapper relative z-10 max-w-7xl mx-auto px-4">
        ...
        <div className="text-center mb-16 space-y-4">
          <div className="flex items-center justify-center gap-2 mb-4">
            ...
            <span className="text-[#e1b11b] font-bold text-sm tracking-widest uppercase">Google Reviews</span>
          </div>
          ...
          <p className="text-gray-400 text-lg max-w-2xl mx-auto">
            Real feedback from our satisfied customers in Fairfield County.
          </p>
        </div>
          ...
          <div className="overflow-hidden mx-4 md:mx-12">
            ...
            >
              {Array.from({ length: totalPages }).map((_, pageIndex) => {
                // Logic to group cards based on screen size (1 or 2 per slide)
                        ...
                        <div className="flex items-center gap-4 mt-auto border-t border-gray-800 pt-6">
                          ...
                          <div>
                            ...
                            <div className="flex items-center gap-1">
                              ...
                              <p className="text-gray-500 text-xs font-medium uppercase tracking-wider">{review.role}</p>
                            </div>
                          </div>
                        </div>
                      </div>
