      ...
      <div className="container-wrapper relative z-10 max-w-7xl mx-auto px-4">
        ...
        <div className="text-center mb-16 space-y-4">
          <a
            ...
            className="inline-flex items-center justify-center gap-2 mb-4 hover:opacity-90 transition-opacity"
          >
              ...
              return (
                <div key={pageIndex} className="min-w-full flex gap-6 px-2">
                  {currentItems.map((review, idx) => (
                    ...
                    >
                      {/* Google Reviews Badge inside card (replaces quote icon) */}
                      <a
                        href={GOOGLE_REVIEWS_URL}
                        target="_blank"
                        rel="noopener noreferrer"
                      ...
                      <div className="flex items-center justify-between gap-4 mt-auto border-t border-gray-800 pt-6">
                        <div className="flex items-center gap-4">
                          ...
                          <div itemProp="author" itemScope itemType="https://schema.org/Person">
                            <h4 className="text-white font-bold" itemProp="name">
                              {review.name}
                            </h4>
                        ...
                        <a
                          ...
                          target="_blank"
                          rel="noopener noreferrer"
                          className="text-xs text-[#e1b11b] font-semibold hover:underline whitespace-nowrap"
                        >
                          View on Google
                        </a>
                      </div>
