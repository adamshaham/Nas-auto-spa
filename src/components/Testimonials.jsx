...
const GOOGLE_REVIEWS_URL = "https://share.google/whU8wUAAESFLZUJ3m";
...
const Testimonials = () => {
  ...
  // ✅ Handle responsive breakpoint in React instead of reading window in render
  useEffect(() => {
    const handleResize = () => {
  ...
  return (
    <section
      id="testimonials"
      className="py-16 md:py-24 bg-black relative overflow-visible"
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6">
        ...
        <div className="text-center mb-10 sm:mb-16 space-y-3 sm:space-y-4">
          <a
            ...
            className="inline-flex items-center justify-center gap-2 mb-3 sm:mb-4 hover:opacity-90 transition-opacity"
          >
            <span
              className="w-7 h-7 sm:w-8 sm:h-8 bg-white rounded-full flex items-center justify-center shadow-lg"
              aria-hidden="true"
            >
            ...
            <span className="text-[#e1b11b] font-bold text-xs sm:text-sm tracking-widest uppercase">
              Google Reviews
            </span>
          </a>
        ...
        <div className="relative" aria-roledescription="carousel">
          {/* Desktop Navigation Buttons (side arrows) */}
          <button
            onClick={prev}
            className="hidden md:flex absolute -left-4 top-1/2 -translate-y-1/2 z-20 p-3 rounded-full bg-[#e1b11b] text-black hover:bg-white hover:scale-110 transition-all shadow-[0_0_20px_rgba(225,177,27,0.3)]"
          ...
          <button
            onClick={next}
            className="hidden md:flex absolute -right-4 top-1/2 -translate-y-1/2 z-20 p-3 rounded-full bg-[#e1b11b] text-black hover:bg-white hover:scale-110 transition-all shadow-[0_0_20px_rgba(225,177,27,0.3)]"
          ...
          {/* Reviews Slider */}
          <div className="overflow-hidden mx-1 sm:mx-4 md:mx-12">
            <div
            ...
            >
              {Array.from({ length: totalPages }).map((_, pageIndex) => {
                ...
                return (
                  <div
                    key={pageIndex}
                    className="min-w-full flex flex-col md:flex-row gap-4 md:gap-6 px-1 sm:px-2"
                  >
                    {currentItems.map((review, idx) => (
                      ...
                      >
                        ...
                        <a
                          ...
                          aria-label="View NAS Auto Spa reviews on Google"
                        >
                          <div className="w-10 h-10 sm:w-12 sm:h-12 rounded-full bg-white flex items-center justify-center shadow-lg p-1">
                            <img
                        ...
                        {/* Author Profile + Google link */}
                        <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 mt-auto border-t border-gray-800 pt-4 sm:pt-6">
                          ...
                          <a
                            ...
                            target="_blank"
                            rel="noopener noreferrer"
                            className="text-[11px] sm:text-xs text-[#e1b11b] font-semibold hover:underline whitespace-nowrap"
                          >
                            View on Google
                          </a>
                        </div>
          ...
          <div className="mt-6 flex md:hidden justify-center gap-4">
            <button
              onClick={prev}
              className="p-2.5 rounded-full bg-[#e1b11b] text-black hover:bg-white transition-all shadow-[0_0_16px_rgba(225,177,27,0.3)]"
              aria-label="Previous review"
            >
        ...
        <div className="mt-8 sm:mt-10 text-center text-xs sm:text-sm text-gray-400">
          Want to see more or leave your own review?{" "}
          <a
            href={GOOGLE_REVIEWS_URL}
            target="_blank"
            rel="noopener noreferrer"
          ...
          >
            View all NAS Auto Spa reviews on Google
          </a>
          .
        </div>
      </div>
