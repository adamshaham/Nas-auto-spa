      ...
      <div className="container-wrapper relative z-10">
        ...
        <div className="grid md:grid-cols-4 gap-12 mb-16 px-4">
          ...
          <div className="space-y-6">
            ...
            <div className="flex space-x-4">
              <a href="https://www.instagram.com/nas.auto.spa/" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-gold-500 transition-colors">
        ...
        <div className="border-t border-gray-800 pt-8 mt-8 text-center px-4">
          <p className="text-gray-400">
            © {currentYear} NAS Auto Spa. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
